...
-- DropForeignKey
ALTER TABLE "GymAdmin" DROP CONSTRAINT "GymAdmin_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "GymAdmin" ADD CONSTRAINT "GymAdmin_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
