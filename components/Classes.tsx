...
const classes = [
  {
    ...
    description:
      "Transforme seu corpo com força e disciplina no body building.",
  },
  {
    name: "cardio",
    img: "/assets/img/classes/cardio.jpg",
    description:
      "Melhore sua resistência e saúde com treinamento cardiovascular.",
  },
  {
    name: "crossfit",
    img: "/assets/img/classes/crossfit.jpg",
    description:
      "CrossFit combina força, resistência e agilidade para um treino completo e desafiador.",
  },
  {
    name: "fitness",
    img: "/assets/img/classes/fitness.jpg",
    description:
      "Fitness é o caminho para uma vida saudável, combinando exercícios, nutrição e bem-estar.",
  },
];
const Classes = () => {
  return (
